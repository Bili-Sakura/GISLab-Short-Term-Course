...
from image_display import display_ablation_steps_t2i
...
def main():
    ...
    # Configure logging
    with open("configs/config_steps_t2i.yaml", "r") as config_file:
