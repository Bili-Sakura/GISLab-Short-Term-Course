...
parser.add_argument('--output_path', type=str, default="./out/diffusionsat_weighting_1.png")
...
image = pipe(prompt_embeds=prompt_embeds, generator=generator, metadata=metadata, num_inference_steps=20, guidance_scale=7.5, height=512, width=512).images[0]
