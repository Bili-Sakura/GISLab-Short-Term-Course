...
parser.add_argument('--prompt', type=str, default = "In the midst of a flood, a scene unfolds with a serpentine river, its ink-green waters enveloping the landscape. The right side reveals a partially submerged forest under the murky depths, while the left side displays a dense, verdant backdrop punctuated by irregularly shaped, darker patches of earth or rock, contrasting against the lush, multi-hued greenery.")
parser.add_argument('--metadata', nargs='+', type=float, default = [-73.968285, 40.785091, 0.920, 0.080, 2022, 5, 10])
parser.add_argument('--output_path', type=str, default="./out/diffusionsat_hurricane-florence_00000111_4_post_disaster.png")
