...
if (
    ...
    and torch.cuda.get_device_properties(0).total_memory < 48 * 1024**3
    and not args.quant
):
    print(
        "GPU memory is less than 48GB. Please use cli_demo_multi_gpus.py or pass `--quant 4` or `--quant 8`."
    )
    exit()
